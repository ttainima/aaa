...
import pymysql
import paramiko
path="/usr/local/src/.ssh/aaa/task28"
...
def tick2(num,atime,kthe):
   ...
   stdin, stdout, stderr = ssh.exec_command("echo " +log+ ">>/home/git/gcopen/log/xjp28_auto201712.log;echo " +logs+">>/home/git/gcopen/logs/幸运28201712.log")
   print("do")
